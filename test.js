...
console.log('Телефонні номери користувачів, у яких баланс більше $2000 : ');
...
console.log(`Сума балансів користувачів, у яких баланс більше $2000 : ${usersBalanceSumm(usersResult)}`);
